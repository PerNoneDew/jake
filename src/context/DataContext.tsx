...
import { HealthRecord, Request, Medicine, Expense, Notification, AuditLog, BackupRecord, MedicineDispensing, User, DataSnapshot, HealthFormRequest, PatientVisit, Referral, FollowUp, Appointment, MedicalSupply, StockTransaction, Supplier, Purchase } from '../types';
...
export function DataProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const [hr, req, med, exp, notif, audit, backup, disp, snap, hfr, pv, ref, fu, appt, ms, st, sup, pur] = await Promise.all([
