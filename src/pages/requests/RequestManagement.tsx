...
import { Plus, Search, Eye, CheckCircle, XCircle, Clock, RefreshCw, Paperclip, Share2, PackageCheck, Stethoscope, Smile, Pill, Upload, FileText, X, Loader2 } from 'lucide-react';
