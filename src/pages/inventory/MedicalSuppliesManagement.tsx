...
import { Plus, Search, CreditCard as Edit2, AlertTriangle, Package, CheckCircle, Calendar, Trash2 } from 'lucide-react';
...
const emptyForm: FormData = { name: '', category: '', quantity: 0, unit: 'pieces', minStock: 0, expiryDate: '', supplier: '' };
