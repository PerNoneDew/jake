...
import { Search, Eye, Plus, Stethoscope, Smile, HeartPulse, Pill } from 'lucide-react';
...
const serviceConfig: Record<ServiceType, { label: string; icon: React.ElementType; color: string }> = {
  ...
  dental: { label: 'Dental', icon: Smile, color: 'text-amber-600' },
...
export default function VisitListPage({ serviceType, title, description }: VisitListPageProps) {
  ...
  const svcConfig = serviceConfig[serviceType];
