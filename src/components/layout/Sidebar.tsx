...
import {
  ...
  Stethoscope, Smile, Pill, Share2, RefreshCw, CalendarClock,
  ShoppingCart, Truck, ArrowLeftRight, Upload, Printer, UserCog,
  Lock, GraduationCap, Briefcase, HeartPulse,
} from 'lucide-react';
...
const navGroups: NavGroup[] = [
  {
    ...
    roles: ['admin', 'health_officer', 'student', 'staff', 'faculty', 'employee'],
  },
  {
...
export default function Sidebar({ currentPage, onNavigate }: SidebarProps) {
  ...
  const visibleGroups = navGroups.filter((g) => g.roles.includes(currentUser.role));
